...
digits_exp135:
	glia_digits.py VAE --glia=True --num_epochs=100 --vae_path=$(DATA_PATH)/digits_exp134_VAE_only.pytorch --progress=True --use_gpu=True --save=$(DATA_PATH)/digits_exp135 | tee $(DATA_PATH)/digits_exp135.log
