...
# Playing w/ num_hidden_n and random neurons
digits_exp18:
	glia_digits.py --glia=True --epochs=300 --progress=True --lr=0.005 --use_cuda=True --device_num=1 --conv=False --random_neurons=True --num_hidden_n=48 | tee digits_exp18.log